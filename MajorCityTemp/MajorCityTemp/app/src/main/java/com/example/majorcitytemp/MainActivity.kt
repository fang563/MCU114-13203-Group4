...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cities=arrayOf("Keelung","Taipei","New Taipei","Taoyuan","Hsinchu","Miaoli","Taichung","Changhua","Nantou","Yunlin","Chiayi","Tainan","Kaohsiung","Pingtung")
    ...
    private fun fetchWeather(cityName:String) {
        ...
        val apiKey = "4e19c4f7fc39c6ee769dd9b6500505eb"
